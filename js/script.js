  // Ambient full-hero waveform — large, slow, sits behind the whole hero (and reused in Prueba social)
  ...
  // Efecto máquina de escribir para "Informe entregado el mismo día"
  ...
  // 3D parallax on mouse move — wedge field, in harmony with ambient waveform drift
  ...
  if(!reduceMotion){
    heroSection.addEventListener('mousemove', (e)=>{
      ...
      // ambient waveform drifts same direction as the wedges, same gentle scale — one coherent scene
  ...
  if(!reduceMotion && scrollParallaxEls.length){
    let ticking = false;
